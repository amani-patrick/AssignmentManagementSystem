...
<div class="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
    <h2 class="text-2xl font-bold text-center text-indigo-700 mb-4">Student Registration</h2>
    ...
    <form action="student_register" method="post">
        ...
        <input type="date" name="dob" required class="w-full p-3 border rounded-lg mt-2 bg-gray-50">
